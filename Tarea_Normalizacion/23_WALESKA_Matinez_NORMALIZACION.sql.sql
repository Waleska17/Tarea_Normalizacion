...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-05-2021 a las 17:29:19
...
--
-- Base de datos: `db_restaurantre2`
--
...
CREATE TABLE `tbl_envios` (
  ...
  `DESCRIPCION_ENVIOS` varchar(300) NOT NULL,
  `FECHA` date NOT NULL,
  `ID_DIRECCION` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
ALTER TABLE `tbl_factura`
  ...
  ADD KEY `FK_DIRECCIONES_FACTURA` (`ID_DIRECCION`);
...
ALTER TABLE `tbl_pedidos`
  ...
  ADD KEY `FK_DIRECCIONES_PEDIDEOS` (`ID_DIRECCION`);
